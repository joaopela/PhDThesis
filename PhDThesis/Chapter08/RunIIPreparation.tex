...
\caption[Results of the search for L1T algorithms with a maximum rate of $5\,\kilo\hertz$ for the \textit{TSG high luminosity scenario}.]
{Results of the search for \gls{L1T} algorithms with a maximum rate of $5\,\kilo\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. Base criteria is fixed while an additional variable is scanned and its value is set by the allowed maximum rate. Results are presented in descending order of additional signal collection efficiency relative to L1\_ETM70, while individual efficiency is the sole algorithm signal efficiency.}
...
\caption[Plots produced by the optimization process of possible L1T algorithms with a maximum rate of $5\,\kilo\hertz$ for the \textit{TSG high luminosity scenario}.]
{Plots produced by the optimization process of possible \gls{L1T} algorithms with a maximum rate of $5\,\kilo\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. Both figures require events with at least one dijet in opposite sides of the detector passing $\pt^{jets}>30$ and $\Delta\eta>3.5$. Figure (a) shows the scan over \gls{L1T} \gls{MET} while figure (b) shows the scan over leading jet \pt. The red line is the estimated rate in $\hertz$, the blue line the faction of accepted signal and the green shaded area the additional efficiency relative to L1\_ETM70.}
...
\caption[Results of the automatic optimization of possible HLT paths for a maximum rate of $5\,\hertz$ for the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by L1\_ETM70.]
{Results of the automatic optimization of possible \gls{HLT} paths for a maximum rate of $5\,\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by L1\_ETM70. Results are presented for the best dijet symmetric and asymmetric \pt thresholds, for maximum total signal efficiency, maximum additional signal efficiency to HLT\_PFMET170\_NoiseCleaned, and lowest \gls{PF} \gls{MET}.}
...
\caption[Plots showing the scan over HLT PF MET for different algorithm base selection in the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by L1\_ETM70.]
{Plots showing the scan over \gls{HLT} \gls{PF} \gls{MET} for different algorithm base selection in the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by L1\_ETM70. Figure (a) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>40,40\,\GeV$, $\Delta\eta>3.5$ and $M_{jj}>600\,\GeV$ while figure (b) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>60,40\,\GeV$, $\Delta\eta>3.7$ and $M_{jj}>500\,\GeV$.}
...
\caption[Trigger turn ons for the VBF Higgs to invisible dedicated trigger for $\text{MET}_{no-\mu}$, dijet sub-lead jet \pt, dijet $\Delta\eta_{jj}$ and dijet $M_{jj}$.]
{Trigger turn ons for the \gls{VBF} Higgs to invisible dedicated trigger for (a) $\text{MET}_{no-\mu}$ (includes comparison with the trigger menu \gls{MET} only trigger), (b) dijet sub-lead jet \pt, (c) dijet $\Delta\eta_{jj}$ and (d) dijet $M_{jj}$~\cite{IMAGEREF:LHCJamboree}.}
...
\caption[Results of the automatic optimization of possible HLT paths for a maximum rate of $5\,\hertz$ for the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by proposed L1T algorithm selecting a dijet passing requirements VBF, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and $ETM \geq 50\,\GeV$.]
{Results of the automatic optimization of possible \gls{HLT} paths for a maximum rate of $5\,\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by proposed \gls{L1T} algorithm selecting a dijet passing requirements \gls{VBF}, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and $ETM \geq 50\,\GeV$. Results are presented for the best dijet symmetric and asymmetric \pt thresholds, for maximum total signal efficiency, maximum additional signal efficiency to HLT\_PFMET170\_NoiseCleaned, and lowest \gls{PF} \gls{MET}.}
...
\caption[Plots showing the scan over HLT PF MET for different algorithm base selection in the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by proposed L1T algorithm selecting a dijet passing requirements VBF, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and $ETM \geq 50\,\GeV$.]
{Plots showing the scan over \gls{HLT} \gls{PF} \gls{MET} for different algorithm base selection in the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by proposed \gls{L1T} algorithm selecting a dijet passing requirements \gls{VBF}, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and $ETM \geq 50\,\GeV$. Figure (a) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>60,40\,\GeV$, $\Delta\eta>4.1$ and $M_{jj}>500\,\GeV$ while figure (b) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>40,40\,\GeV$, $\Delta\eta>4.1$ and $M_{jj}>600\,\GeV$.}
...
\caption[Results of the automatic optimization of possible HLT paths for a maximum rate of $5\,\hertz$ for the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by proposed L1T algorithm selecting a dijet passing requirements VBF, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and a single jet $\pt^{jets}>96\,\GeV$.]
{Results of the automatic optimization of possible \gls{HLT} paths for a maximum rate of $5\,\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by proposed \gls{L1T} algorithm selecting a dijet passing requirements \gls{VBF}, $\pt^{jets}>30\,\GeV$, and $\Delta\eta>3.5$ and a single jet $\pt^{jets}>96\,\GeV$. Results are presented for the best dijet symmetric and asymmetric \pt thresholds, for maximum total signal efficiency, maximum additional signal efficiency to HLT\_PFMET170\_NoiseCleaned, and lowest \gls{PF} \gls{MET}.}
...
\caption[Plots showing the scan over HLT PF MET for different algorithm base selection in the \textit{TSG high luminosity scenario}. All HLT algorithms are seeded by proposed L1T algorithm selecting a dijet passing requirements VBF, $\pt^{jets}>30\,\GeV$, and a single jet $\pt^{jets}>96\,\GeV$.]
{Plots showing the scan over \gls{HLT} \gls{PF} \gls{MET} for different algorithm base selection in the \textit{\gls{TSG} high luminosity scenario}. All \gls{HLT} algorithms are seeded by proposed \gls{L1T} algorithm selecting a dijet passing requirements \gls{VBF}, $\pt^{jets}>30\,\GeV$, and a single jet $\pt^{jets}>96\,\GeV$. Figure (a) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>90,40\,\GeV$, $\Delta\eta>4.1$ and $M_{jj}>500\,\GeV$ while figure (b) base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>40,40\,\GeV$, $\Delta\eta>4.3$ and $M_{jj}>800\,\GeV$.}
...
\caption[Results of the automatic optimization of possible HLT path for a maximum rate of $500\,\hertz$ for the \textit{TSG high luminosity scenario}. The HLT algorithm is seeded by L1\_ETM50]
{Results of the automatic optimization of possible \gls{HLT} path for a maximum rate of $500\,\hertz$ for the \textit{\gls{TSG} high luminosity scenario}. The \gls{HLT} algorithm is seeded by L1\_ETM50. Figure shows the scan over \gls{HLT} \gls{PF} \gls{MET} for base configuration requiring a dijet on opposite sides of the detector, $p_T^{jet_1},p_T^{jet_2}>40,40$, $\Delta\eta>3.5$ and $M_{jj}>600\,\GeV$}
...
\caption[Key variables of events passing the parton level filter.]
{Parton \pt, $\eta$ and di-parton $m_jj$ distributions for the leading di-parton passing cuts: parton $p_{T}>30\,\GeV$ and $|\eta|<5.0$, di-parton $M_{jj}>800\,\GeV$.}
...
\input{Chapter08/QCDVBFSamples/Hadronization/Table/Pythia8_HadronizationResults.tex}
...
{Relevant distributions for the two jets comprising the the leading dijet passing a generator filter requiring at least one dijet with $\Delta\eta>3.0$ and $M_{jj}>1000\,\GeV$ where the jets have $\pt>40\,\GeV$ and $|\eta|<4.8$}
...
{Relevant distributions for the leading dijet passing a generator filter requiring at least one dijet with $\Delta\eta>3.0$ and $M_{jj}>1000\,\GeV$ where the jets have $\pt>40\,\GeV$ and $|\eta|<4.8$}
...
\input{Chapter08/QCDVBFSamples/GeneratorFilter/Tables/GeneratorJets_PassFilter_NJets_Dphi.tex}
...
\input{Chapter08/QCDVBFSamples/GeneratorFilter/Tables/GeneratorJets_PassFilter_NDijets_Dphi.tex}
...
\input{Chapter08/QCDVBFSamples/Migrations/Tables/PartonGenJetMatchingEfficiency.tex}
...
\caption[Plots for relevant variables of the selected di-parton against its matched dijet: Lead parton \pt, sub-leading parton \pt, lead parton $\eta$, sub-lead parton $\eta$, di-parton $\Delta\eta$ and di-parton $M_{jj}$.]
{Plots for relevant variables of the selected di-parton against its matched dijet: (a) lead parton \pt (b) sub-leading parton \pt (c) lead parton $\eta$ (d) sub-lead parton $\eta$ (e) di-parton $\Delta\eta$ (d) di-parton $M_{jj}$.}

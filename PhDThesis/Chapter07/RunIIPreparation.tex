...
Proposal to the Higgs sample generation contacts consists on the production of a MadGraph QCD sample with \gls{VBF} characteristics and no missing transverse energy cut.
...
\input{Chapter07/QCDVBFSamples/Gridpack/Tables/table_GridPack_HadronizationResults.tex}

\input{Chapter07/QCDVBFSamples/Gridpack/Tables/table_Gridpack_PartonGenJetMatchingResults.tex}

\begin{figure}[htp]%
\centering
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_Parton1_Pt.pdf}}\qquad
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_Parton2_Pt.pdf}}\\
\caption[TODO]{TODO}
\label{FIGURE:TODO}
\end{figure}
...
\begin{figure}[htp]%
\centering
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_Parton1_Eta.pdf}}\qquad
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_Parton2_Eta.pdf}}\\
\caption[TODO]{TODO}
\label{FIGURE:TODO}
\end{figure}
...
\begin{figure}[htp]%
\centering
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_DEta.pdf}}\qquad
\subfloat[][]{\includegraphics[width=0.45\linewidth]{Chapter07/QCDVBFSamples/Gridpack/Images/SelDiParton_Mjj.pdf}}\\
\caption[TODO]{TODO}
\label{FIGURE:TODO}
\end{figure}

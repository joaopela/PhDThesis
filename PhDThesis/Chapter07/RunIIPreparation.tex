...
%%% SUBSECTION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{L1T algoritm development}
...
%Dijet30 + VBF + DEta>=3.5 + ETM>=50.09 with rate 4961 Hz, signal eff of 13.6\% from which 4.0\% are not trigger by ETM70
%Dijet30 + VBF + DEta>=3.5 + Single Jet pT>=96.72 with rate 4632 Hz, signal eff of 14.6\% from which 5.5\% are not trigger by ETM70 
...
\caption[L1T]{L1T}
\label{FIGURE:RunIIPreparation_L1T}
\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% SUBSECTION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{HLT algoritm development}


% 9.4\% from HLT_PFMET170 
...
\subsubsection{L1T Seed: L1T\_ETM70}
...
\hline
Algorithm & \multicolumn{6}{c|}{Event Requirements} & Rate & \multicolumn{2}{c|}{Signal Efficiency} \\
\hline
Type       & $p_T^{jet_1}\,[\GeV]$  & $p_T^{jet_2}\,[\GeV]$ & VBF & $\Delta\eta$ & $M_{jj}\,[\GeV]$ & MET $[\GeV]$ & HLT Rate [Hz] & Total [\%] & Additional [\%] \\
\hline\hline
\multicolumn{10}{|c|}{Maximum efficiency for jets} \\
\hline\hline
Asymmetric &                     70 &                    40 &        Yes &          3.5 &              500 &          144 &          4.99 &      5.18  &            1.37 \\
Symmetric  &                     40 &                    40 &        Yes &          3.5 &              600 &          140 &          4.68 &      5.16  &            1.49 \\
\hline\hline
\multicolumn{10}{|c|}{Maximum Additional Efficiency} \\
\hline\hline
Asymmetric &                     60 &                    40 &        Yes &          3.7 &              500 &          140 &          4.84 &      5.13  &            1.55 \\
Symmetric  &                     40 &                    40 &        Yes &          3.5 &              600 &          140 &          4.68 &      5.16  &            1.49 \\
\hline\hline
\multicolumn{10}{|c|}{Lowest MET Threshold} \\
\hline\hline
...
\subsubsection{L1T Seed: Dijet30 + VBF + DEta>=3.5 + ETM>=50}
...
\subsubsection{L1T Seed: Dijet30 + VBF + DEta>=3.5 + Single Jet pT>=96}
...
Type       & $p_T^{jet_1}\,[\GeV]$  & $p_T^{jet_2}\,[\GeV]$ & VBF & $\Delta\eta$ & $M_{jj}\,[\GeV]$ & MET $[\GeV]$ & HLT Rate [Hz] & Total [\%] & Additional [\%] \\
\hline\hline
\multicolumn{10}{|c|}{Maximum efficiency} \\
\hline\hline

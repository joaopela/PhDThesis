...
\hline
\end{tabular}
\caption{Table showing the percentage of generator AK4 jets passing cuts $p_T>40\,\GeV$ and $|\eta|<4.8$ for events with at least one dijet with $\Delta\eta<3.0$ and $m_{jj}<1000\,\GeV$ and according to an additional dijet $\Delta\phi$ cut.}
\end{table}

...
\caption[Distributions of Pseudorapidity difference between the two selected \gls{VBF} jets, $\Delta\eta_{jj}$, Dijet mass $M_{jj}$, \gls{MET} significance $\mathcal{S}$ and \gls{MET}, in the $Z\rightarrow \mu\mu$ control region as seen by the cross check analysis.]

...
\begin{figure}[!htb]
\centering
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/enu_dijet_M.pdf}}
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/munu_dijet_M.pdf}} \\
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/taunu_dijet_M.pdf}}
...
\begin{figure}[!htb]
\centering
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/enu_metnomuons.pdf}}
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/munu_metnomuons.pdf}} \\
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/taunu_metnomuons.pdf}}
...
\begin{figure}[!htb]
\centering
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/enu_alljetsmetnomu_mindphi.pdf}}
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/munu_alljetsmetnomu_mindphi.pdf}} \\
\subfloat[]{\includegraphics[width=.49\textwidth]{Chapter07/Images/output_sigreg/taunu_alljetsmetnomu_mindphi.pdf}}

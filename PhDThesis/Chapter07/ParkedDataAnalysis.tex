...
\caption{Table of the step by step event yields for the signal region obtained by the cross check analysis. Yields are discriminated by Run I period. Exact matching was achieved with the main analysis in each run period.}

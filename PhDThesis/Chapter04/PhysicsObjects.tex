...
Reconstructing the trajectories of charged particles allows us to measure their momentum and determining their charge. This is possible by analysing the hit patterns in the inner tracking system. In \gls{CMS} this reconstruction is made with the \gls{CTF} algorithm\cite{ARTICLE:CMSTrackReconstruction}.




\cite{ARTICLE:CMSTrackReconstruction} %AG 62

\cite{ARTICLE:KalmanFilteringTrackVertexFitting} %AG 63

\cite{ARTICLE:CMSMeasurmentTrackEfficiency} %AG 64

...
Reconstruction of hadronic tau neutrinos with \gls{PF} is done by identifying the specific decay mode visible decay products. This approach is referred to as the \textit{hadron-plus-strips} algorithm \cite{ARTICLE:CMSPerformaceOfTauLeptonReconstruction}. It combines reconstructed charged hadrons with strips of clustered photons which are interpreted as $\pi_0$. 

...
\subfloat[]{\includegraphics[width=0.45\textwidth]{Chapter04/MET/Images/met_gamma.pdf}}\\
 \caption[Distributions of the particle flow $\MET$ in $Z\rightarrow\gamma\gamma$and $\gamma$+jets events in $\sqrt{s}=8\,\TeV$ data and simulation.]{Distributions of the particle flow $\MET$ in a) $Z\rightarrow\gamma\gamma$ and b) $\gamma$+jets events in $\sqrt{s}=8\,\TeV$ data and simulation. The shaded band reflects the uncertainty in the muon, photon, jet and neutral hadron energy responses \cite{ARTICLE:CMSMissingTransverseEnergyPerformance}.}
\label{FIGURE:PhysicsObjects_MET}
\end{figure}


% \cite{ARTICLE:CMSMissingTransverseEnergyPerformance} % AG 83
% \cite{ARTICLE:CMSMETPerformance8TeV}                 % AG

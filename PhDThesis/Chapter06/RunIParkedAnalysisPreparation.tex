...
These results were used to define working points for this trigger, which were proposed to the \gls{TSG} to be included on \gls{L1T} menu. The proposed trigger options were:
\begin{itemize}

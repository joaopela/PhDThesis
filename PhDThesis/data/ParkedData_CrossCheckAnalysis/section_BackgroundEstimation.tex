...
\input{Region_ElectronMET/Region_ElectronMET_AbsoluteEventYields}
\input{Region_ElectronMET/Region_ElectronMET_MainAnalysisCompare.tex}
...
\input{Region_MuonMET/Region_MuonMET_AbsoluteEventYields.tex}
\input{Region_MuonMET/Region_MuonMET_MainAnalysisCompare.tex}

\subsection{W to \texorpdfstring{$\tau$+\MET}{tau+MET}}

\input{Region_TauMET/Region_TauMET_AbsoluteEventYields.tex}
\input{Region_TauMET/Region_TauMET_MainAnalysisCompare.tex}
...
\input{Region_Zmumu/Region_Zmumu_AbsoluteEventYields.tex}
\input{Region_Zmumu/Region_Zmumu_MainAnalysisCompare.tex}
...
\input{Region_Top/Region_Top_AbsoluteEventYields.tex}
\input{Region_Top/Region_Top_MainAnalysisCompare.tex}

\subsection{QCD}

\input{Region_QCD/Region_QCD_AbsoluteEventYields.tex}

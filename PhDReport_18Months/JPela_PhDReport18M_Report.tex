...
The CMS detector is ideal for these type of searches since it is a $4\pi$ hermetic detector with calorimeter coverage
...
One of the most difficult background to estimatein the VBF Higgs to invisible analysis is QCD. This is mostly due to
...
interest. This implies the higher it is also the better is the average relative object resolution. This variable can also
be used to relax constrains on individual object but still for minimum global transverse energy of the combined system.
...
Based on the method of some CMS SUSY analysis that use and HT cut in conjunction with the $\alpha_T$ variables, a 
study was performed to evaluate the possibility of combining the scalar sri-object sum with each of dijet plus MET 
variables. Two dimensional plots for the signal monte carlo after the the MET cut on the official VBF to invisible
...
Preliminary studies show that by defining a 2D cut on this pairs of variables could yield a reduction of a factor of
2.5 on QCD, Z+Jet and W+Jets with a signal loss of less than 30\%. 

This studies may prove specially valuable for use in parked data, since by applying constraints on this type of system
variables we may be able to relax cut on jet $p_T$ and MET and therefore increase signal yield making use of the lower 
trigger thresholds for this individual objects. While keeping or oven improving signal to background ratio.
